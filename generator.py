...
raw.append(Tag(60, 60, 70, 90, 'div', '\tborder: 2px solid white;\n', ''))
raw.append(Tag(80, 60, 90, 90, 'div', '\tborder: 2px solid white;\n', ''))
html = HTML(100, 100, raw)
html.write('test1.html', 'test1.css')
...
html = HTML(100, 100, raw)
html.write('test4.html', 'test4.css')
...
html = HTML(100, 100, raw)
html.write('test5.html', 'test5.css')